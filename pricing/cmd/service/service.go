...
import (
	...
	http "github.com/tancejang/go_challenge_pricing_service/pricing/pkg/http"
...
var fs = flag.NewFlagSet("pricing", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "pricing")
